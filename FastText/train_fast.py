        ...
        with sess.as_default():
            ...
            def train_step(x_batch_front, x_batch_behind, y_batch):
                ...
                _, step, summaries, loss, accuracy = sess.run(
                    [train_op, fasttext.global_step, train_summary_op, fasttext.loss, fasttext.accuracy], feed_dict)
            ...
            def validation_step(x_batch_front, x_batch_behind, y_batch, writer=None):
                ...
                step, summaries, loss, accuracy, recall, precision, f1, auc = sess.run(
                    [fasttext.global_step, validation_summary_op, fasttext.loss, fasttext.accuracy,
                     fasttext.recall, fasttext.precision, fasttext.F1, fasttext.AUC], feed_dict)
